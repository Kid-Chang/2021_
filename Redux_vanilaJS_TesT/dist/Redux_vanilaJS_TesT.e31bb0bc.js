...
var DECREASE = "DECREASE"; // 액션 객체 만드는 액션 생성 함수. 반드시 type 값을 가져야 한다.
...
var store = (0, _redux.createStore)(reducer); // render 함수 만들기. 상태가 업데이트될 때마다 호출됨.
...
render(); // 구독기능 구현.(스토어 상태가 변경될때마다 호출, react-redux에선 필요 X)
...
//# sourceMappingURL=/Redux_vanilaJS_TesT.e31bb0bc.js.map